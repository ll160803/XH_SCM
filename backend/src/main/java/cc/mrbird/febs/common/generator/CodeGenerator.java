...
public class CodeGenerator {
    ...
    // xml 文件模板
    private static final String XML_MAPPER_TEMPLATE_PATH = "generator/templates/scm.xml";
    // dao 文件模板
    private static final String MAPPER_TEMPLATE_PATH = "generator/templates/scm.java";
    // entity 文件模板
    ...
    public static void main(String[] args) {
        ...
        packageConfig.setModuleName("scm");
