<template>
    <a-card :bordered="false" class="card-area">
        ...
        <div>
            <div class="operator">
                <a-button v-hasPermission="['scmBQuotedprice:add']" type="primary" ghost @click="add">新增</a-button>
                <a-button v-hasPermission="['scmBQuotedprice:delete']" @click="batchDelete">删除</a-button>
                <a-dropdown v-hasPermission="['scmBQuotedprice:export']">
                    <a-menu slot="overlay">
            ...
            <a-table ref="TableInfo"
                ...
                <template slot="operation" slot-scope="text, record">
                    <a-icon v-hasPermission="['scmBQuotedprice:update']" type="setting" theme="twoTone" twoToneColor="#4a9ff5" @click="edit(record)" title="修改"></a-icon>
                    <a-badge v-hasNoPermission="['scmBQuotedprice:update']" status="warning" text="无权限"></a-badge>
                </template>
            </a-table>
        </div>
        <!-- 新增字典 -->
...
<script>
    ...
    export default {
        ...
        components: {ScmBQuotedpriceAdd, ScmBQuotedpriceEdit},
        data () {
            return {
                advanced: false,
                dataSource: [],
