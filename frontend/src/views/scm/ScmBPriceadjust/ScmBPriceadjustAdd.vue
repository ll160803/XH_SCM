...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            setFields () {
                let values = this.form.getFieldsValue([  'id'     ,  'code'     ,  'name'     ,  'matnrId'     ,  'matnr'     ,  'mseht'     ,  'txz01'     ,  'spec'     ,  'createDate'     ,  'oldPrice'     ,  'adjustPrice'     ,  'comments'     ,  'state'     ,  'gysaccount'     ,  'gysname'     ,  'isDeletemark'     ,  'createTime'     ,  'modifyTime'     ,  'createUserId'     ,  'modifyUserId'   ])
                if (typeof values !== 'undefined') {
                    Object.keys(values).forEach(_key => { this.scmBPriceadjust[_key] = values[_key] })
                }
            }
        }
    }
