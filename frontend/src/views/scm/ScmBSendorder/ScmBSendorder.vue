<template>
    <a-card :bordered="false" class="card-area">
        ...
        <div>
            <div class="operator">
                <a-button v-hasPermission="['scmBSendorder:add']" type="primary" ghost @click="add">新增</a-button>
                <a-button v-hasPermission="['scmBSendorder:delete']" @click="batchDelete">删除</a-button>
                <a-dropdown v-hasPermission="['scmBSendorder:export']">
                    <a-menu slot="overlay">
            ...
            <a-table ref="TableInfo"
                ...
                <template slot="operation" slot-scope="text, record">
                    <a-icon v-hasPermission="['scmBSendorder:update']" type="setting" theme="twoTone" twoToneColor="#4a9ff5" @click="edit(record)" title="修改"></a-icon>
                    <a-badge v-hasNoPermission="['scmBSendorder:update']" status="warning" text="无权限"></a-badge>
                </template>
            </a-table>
        </div>
        <!-- 新增字典 -->
